...
\begin{itemize}
  ...
  \item \textbf{AWS EMR}: con questi volumi il cluster è più lento del locale (da \RA{hive}{job_2} a
        \RA{spark-core}{job_1} volte sul dataset completo): tre nodi, rete e coordinamento non vengono ripagati da
...
volte, mentre su YARN restano praticamente costanti (\GU{yarn}{hive}{job_2}--\GU{yarn}{spark-sql}{job_2} volte),
